...
tunable_params! {
    ...
    lmr_cont_4_bonus_scale       = 170, 80..=280,          true;
    lmr_cont_4_bonus_offset      = 120, 0..=200,           true;
    lmr_cont_4_bonus_max         = 1053, 1000..=1600,      true;
    lmr_cont_4_malus_scale       = 199, 80..=280,          true;
    lmr_cont_4_malus_offset      = 60, 0..=200,            true;
    lmr_cont_4_malus_max         = 1223, 1000..=1600,      true;
    ...
    cont_hist_4_bonus_scale      = 111, 80..=280,          true;
    cont_hist_4_bonus_offset     = 200, 0..=300,           true;
    cont_hist_4_bonus_max        = 981, 800..=1600,       true;
    cont_hist_4_malus_scale      = 89, 80..=280,           true;
    cont_hist_4_malus_offset     = 82, 0..=200,            true;
    cont_hist_4_malus_max        = 1025, 800..=1600,       true;
